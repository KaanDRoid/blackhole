"""Medium-res adaptive RK4 renderer.
Produces geodesic_adaptive_medium.png
"""
import math
...
img.save('geodesic_adaptive_medium.png')
print('Saved geodesic_adaptive_medium.png')
